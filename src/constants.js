...
export const contactLinks = [
  {
    name: "GitHub",
    link: "https://github.com/luccalck",
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="#e6edf3">
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/luccacastilho1/",
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="#e6edf3">
  ...
  {
    name: "Instagram",
    link: "https://www.instagram.com/lc.castilho/",
    svg: `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="#e6edf3">
